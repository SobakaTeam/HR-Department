...
ALTER TABLE
    "Person" ADD CONSTRAINT "person_full_name_unique" UNIQUE("FirstName","LastName","MidleName");
ALTER TABLE
    "Child" ADD CONSTRAINT "child_full_name_unique" UNIQUE("FirstName","LastName","MidleName");
ALTER TABLE
    "Position" ADD CONSTRAINT "position_name_unique" UNIQUE("Name");
ALTER TABLE
    "Department" ADD CONSTRAINT "department_name_unique" UNIQUE("Name");
ALTER TABLE
    "Organization" ADD CONSTRAINT "organization_name_unique" UNIQUE("Name");
